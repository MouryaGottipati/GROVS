...
public class User {
	...
	@Column(name="middle_name",columnDefinition="varchar default ''")
	private String middle_name;
	@Column(name="last_name",nullable=false)
	private String last_name;
	@Column(name="creation_time",insertable=false,updatable=false,columnDefinition="datetime default current_timestamp")
